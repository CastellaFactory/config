...
function! MyEnv()
    ...
    let env = {
                ...
                \       'user' : dot_nvim_dir,
                \       'dein' : {
                \           'bundle' : dot_nvim_dir . 'dein',
                \           'toml' : dot_nvim_dir . 'dein.toml'
                \       },
                \       'nvimrc' : dot_nvim_dir . 'nvimrc',
                \       'local_nvimrc' : dot_nvim_dir . 'local.nvimrc',
                \       'backup' : dot_nvim_dir . 'backups',
                \       'undo' : dot_nvim_dir . 'undo'
                \   },
                \   'language' : {
                \       'c' : {
...
execute 'nnoremap <Space>. :<C-u>edit' resolve(s:env.path.nvimrc) . '<CR>'
...
if filereadable(s:env.path.local_nvimrc)
    source `=s:env.path.local_nvimrc`
endif
